                    ...
                    <div class="card card--col" :id="item.ref" id="Basic">
                        <div class="card__header">
                            <div class="flex items-center justify-between">
                                <h3 class="card__title" x-text="item.title">Mensal</h3><template x-if="item.badge"><span
                                        class="badge" x-text="item.badge"></span></template>
                            </div>
                            <div class="card__price"><span class="price-currency mr-2"
                                    x-text="item.price.currency">R$</span> <span class="price-value"
                                    x-text="item.price[currentPricing]">19,90</span> <span class="price-period"><span
                                        class="px-1">/</span><span x-text="translate()">Mês</span></span></div>
                        </div>
                        ...
                        <div class="card card--col" :id="item.ref" id="Pro">
                            <div class="card__header">
                                ...
                                <div class="card__price">
                                    <span class="price-currency mr-2"
                                        x-text="item.price.currency">
                                        R$
                                    </span>
                                    <span class="price-value"
                                        x-text="item.price[currentPricing]">
                                       {{$plan->price_br}}
                                    </span>
                                    <span
                                        class="price-period">
                            ...
                            <div class="card__footer text-center my-4">
                                <a href="{{ route('choice.plan', ['url' => $plan->url]) }}"
